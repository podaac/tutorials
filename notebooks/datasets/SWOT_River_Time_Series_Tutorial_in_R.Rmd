---
title: "SWOT River Time-Series Tutorial in R"
...
```
 ...
 After clicking on the basin you will see colorful lines which represent reach_ids. 
...
get_reach_data() creates the url to connect with Hydrocron to get all data from those observations you
