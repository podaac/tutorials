...
[Latest Release Notes - Version C KaRIn Science Data Products (aka 2.0)](https://archive.podaac.earthdata.nasa.gov/podaac-ops-cumulus-docs/web-misc/swot_mission_docs/releases/SWOT_VersionC_KaRIn_Products_Release_Note_20241014.pdf) - see section 7 for known features and issues.
...
[Earthdata Webinar: Accessing Data for the World's Water with SWOT](https://www.earthdata.nasa.gov/learn/webinars-and-tutorials/webinar-podaac-2024-03-20) - Learn how to discover, access, and use SWOT mission data and how these data can lead to new, innovative science and applications in the world of water.
