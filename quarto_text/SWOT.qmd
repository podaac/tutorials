...
The following shapefiles (27 MB - nominal orbit, 1.3 MB - calibration orbit), when brought into a GIS tool such as ArcGIS or QGIS, can support the user to more easily navigate and identify the tile ID of the SWOT HR L2 PIXC and PIXCVec data products to facilitate easier, more efficient data search.
