...
Hydrology: *These examples will download either the river vector files or the raster files for January 2024:* 
``` bash
podaac-data-downloader -c SWOT_L2_HR_RiverSP_2.0 -d ./SWOT_L2_HR_RiverSP_2.0/ --start-date 2024-01-01T00:00:00Z --end-date 2024-01-31T23:59:59Z
```
This only downloads 1 hours worth of data for the globe:
```bash
podaac-data-downloader -c SWOT_L2_HR_Raster_2.0 -d ./SWOT_L2_HR_Raster_2.0/ --start-date 2024-01-01T00:00:00Z --end-date 2024-01-01T00:59:59Z
```
...
*Note: There is a known spatial search issue with beta pre-validated data v1.1 in Earthdata Search.*
...
SWOT Raster Multifile Access [in the cloud](../notebooks/datasets/SWOT_Raster_Notebook_cloud.ipynb) | [locally](../notebooks/datasets/SWOT_Raster_Notebook_local.ipynb)
