...
[Click here](https://archive.podaac.earthdata.nasa.gov/podaac-ops-cumulus-docs/web-misc/swot_mission_docs/swot_beta_preval_coverage_20231204.kmz) to download Beta Pre-Validated HR Product KMZ file. The file can be opened in the Google Earth desktop application and viewed like the following:
