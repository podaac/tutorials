...
To support spatial search of SWOT HR data products, the following naming conventions may be of help. *Tip: use these shortname identifiers below when searching for SWOT HR data in the [NASA Earthdata Search porta](https://search.earthdata.nasa.gov/) or programmatically using the CMR API and/or `earthaccess` python library.*
