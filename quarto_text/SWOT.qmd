...
[Search with unique SWORD river reach ID](../notebooks/SWORD_River_Demo.ipynb)

[Search with unique Hydrologic Unit Code (HUC) basin ID](../notebooks/HUC Feature Translation Service Examples-updated-20210804.ipynb)
