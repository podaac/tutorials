...
**7. Create a Pull Request to Merge your Branch with the Master Branch** - From the GitHub Desktop, you can then select "Create Pull Request" and it should open a browser window taking you to the tutorials repository in GitHub.
